...
```{r Joining episode and season with viewership}
# Start here and clean up some of the white space in the air_date column 
# or... mutate them so that they're smushed  togeter or in a different date format 
right_join(viewership, episode_table, by=c("air_date"))
```
